...
public class ASTPrinter extends DefaultVisitor {
	...
	public Object visit(Print node, Object param) {
		...
		print(indent + 1, "variant", "String", node.getVariant());
		return null;
	}
	...
	public Object visit(And node, Object param) {
		...
		printName(indent, "And", node, false);
	...
	public Object visit(Or node, Object param) {
		...
		printName(indent, "Or", node, false);
	...
	public Object visit(VariableReference node, Object param) {
		...
		printCompact(indent, "VariableReference", node, "name", node.getName());
		return null;
	}
	...
	public Object visit(LiteralFloat node, Object param) {
		...
		printCompact(indent, "LiteralFloat", node, "value", node.getValue());
		return null;
	}
